...
export default function Home({contentfragment}) {

  const aemauthorurl = 'https://author-p55117-e571178.adobeaemcloud.com';
  
  return (
    <View>
      <CFBanner1920x390 contentfragment={contentfragment} label="Banner Ad 1920 x 390" aemauthorurl={aemauthorurl}></CFBanner1920x390>
      <CFBanner1300x435 contentfragment={contentfragment} label="Banner Ad 1300 x 435" aemauthorurl={aemauthorurl}></CFBanner1300x435>
